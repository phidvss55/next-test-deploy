...
export const handlers = [
  rest.get('https://api.chec.io/v1/services/locale/chkt_nwarr02343/countries', (req, res, ctx) => {
    return res(
      ctx.json({
        countries: {
          BD: 'Bangladesh',
  ...
  rest.get('https://api.chec.io/v1/services/locale/chkt_nwarr02343/countries/BD/subdivisions', (req, res, ctx) => {
    return res(
      ctx.json({
        subdivisions: {
          '05': 'Bagerhat',
  ...
  rest.get('https://api.chec.io/v1/services/locale/chkt_nwarr02343/countries/IN/subdivisions', (req, res, ctx) => {
    return res(
      ctx.json({
        subdivisions: {
          DL: 'Delhi',
  ...
  rest.post(`https://api.chec.io/v1/checkouts/chkt_nwarr02343`, (req, res, ctx) => {
  ...
  rest.get('https://api.chec.io/v1/checkouts/cart_0o3ND70JjY6g8w', (req, res, ctx) => {
